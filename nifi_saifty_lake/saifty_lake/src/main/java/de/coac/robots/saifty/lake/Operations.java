...
public class Operations {
    ...
    public static void executeDDL(String resources_path, String ddl_file, Statement stmt) throws SQLException, FileNotFoundException, SQLFeatureNotSupportedException {
        System.out.println("staging sucessful");
        Operations op = new Operations();
        //String phrases_staging = op.fileToString(resources_path + ddl_file);
        String content = new Scanner(new File(resources_path + ddl_file)).useDelimiter("\\Z").next();
